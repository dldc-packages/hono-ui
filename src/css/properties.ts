...
export const PROPERTIES_CONFIG: PropertiesMap = {
  ...
  animation: { toCss: "animation", datatype: d.transition },
  animationDelay: { toCss: "animation-delay" },
  animationDirection: { toCss: "animation-direction" },
  animationDuration: { toCss: "animation-duration" },
  animationFillMode: { toCss: "animation-fill-mode" },
  animationIterationCount: { toCss: "animation-iteration-count" },
  animationName: { toCss: "animation-name" },
  animationPlayState: { toCss: "animation-play-state" },
  animationTimingFunction: { toCss: "animation-timing-function" },
  appearance: { toCss: "appearance", datatype: d.appearance },
  aspectRatio: { toCss: "aspect-ratio", datatype: d.aspectRatio },
  backfaceVisibility: { toCss: "backface-visibility", datatype: d.backfaceVisibility },
  ...
  backgroundAttachment: { toCss: "background-attachment", datatype: d.backgroundAttachment },
  backgroundClip: { toCss: "background-clip", datatype: d.backgroundClip },
  backgroundImage: { toCss: "background-image", datatype: d.backgroundImage },
  backgroundPosition: { toCss: "background-position", datatype: d.backgroundPosition },
  backgroundRepeat: { toCss: "background-repeat", datatype: d.backgroundRepeat },
  backgroundSize: { toCss: "background-size", datatype: d.backgroundSize },
  border: { toCss: "border", datatype: d.border },
  borderBottom: { toCss: "border-bottom", datatype: d.border },
  ...
  borderLeft: { toCss: "border-left", datatype: d.border },
  ...
  clipPath: { toCss: "clip-path", datatype: d.effects },
  ...
  containerName: { toCss: "container-name" },
  containerType: { toCss: "container-type", datatype: d.containerType },
  ...
  fieldSizing: { toCss: "field-sizing", datatype: d.fieldSizing },
  ...
  float: { toCss: "float", datatype: d.float },
  ...
  fontStretch: { toCss: "font-stretch", datatype: d.fontStretch },
  ...
  hyphens: { toCss: "hyphens", datatype: d.hyphens },
  imageRendering: { toCss: "image-rendering", datatype: d.imageRendering },
  ...
  perspective: { toCss: "perspective", datatype: d.distance },
  perspectiveOrigin: { toCss: "perspective-origin", datatype: d.effects },
  ...
  rotate: { toCss: "rotate", datatype: d.effects },
  rowGap: { toCss: "row-gap", datatype: d.spacing },
  scale: { toCss: "scale", datatype: d.effects },
  scrollbarColor: { toCss: "scrollbar-color", datatype: d.scrollbarColor },
  scrollbarGutter: { toCss: "scrollbar-gutter", datatype: d.scrollbarGutter },
  ...
  textDecorationColor: { toCss: "text-decoration-color", datatype: d.color },
  textDecorationStyle: { toCss: "text-decoration-style", datatype: d.textDecorationStyle },
  textDecorationThickness: { toCss: "text-decoration-thickness", datatype: d.borderWidth },
  textIndent: { toCss: "text-indent", datatype: d.distance },
  textOverflow: { toCss: "text-overflow", datatype: d.textOverflow },
  textShadow: { toCss: "text-shadow", datatype: d.textShadow },
  textTransform: { toCss: "text-transform", datatype: d.textTransform },
  textUnderlineOffset: { toCss: "text-underline-offset", datatype: d.borderWidth },
  textWrap: { toCss: "text-wrap", datatype: d.textWrap },
  top: { toCss: "top", datatype: d.distance },
  touchAction: { toCss: "touch-action", datatype: d.touchAction },
  transform: { toCss: "transform", datatype: d.transform },
  transformOrigin: { toCss: "transform-origin", datatype: d.effects },
  ...
  wordSpacing: { toCss: "word-spacing", datatype: d.spacing },
  writingMode: { toCss: "writing-mode", datatype: d.writingMode },
